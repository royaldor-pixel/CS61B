...
//                            //如果相等,就直接move,不相等,offset++后move
//                            if (isFirst) {
//                                isFirst = false;
//                                savedValue = tile.value();
//                            } else if (tile.value() == savedValue && mergeable) {
//                                _score += 2 * tile.value();
//                                savedValue = 2 * tile.value();
//                                mergeable = false;
//                            } else {
//                                offset++;
//                                savedValue = tile.value();
//                            }
//                            _board.move(c, size - offset - 1, tile);
//                        }
//                    }
//                }
//            }
...
//                                savedValue = tile.value();
//                            }
//                            _board.move(size - offset - 1, r, tile);
//                        }
//                    }
//                }
//            }
...
//        }
    ...
    public static boolean maxTileExists(Board b) {
        ...
        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                Tile tileToTest = b.tile(i, j);
                if (tileToTest != null && tileToTest.value() == MAX_PIECE) {
                    return true;
                }
            }
        }
        ...
        if (emptySpaceExists(b)) {
            ...
            for (int i = 0; i < size - 1; i++) {
                for (int j = 0; j < size; j++) {
                    ...
                    int nextColValue = b.tile(i + 1, j).value();
                    if (j != size - 1) {
                        int nextRowValue = b.tile(i, j + 1).value();
                        if (nextRowValue == curValue) {
                            return true;
                        }
                    }
                    if (nextColValue == curValue) {
                        return true;
                    }
                }
            }
